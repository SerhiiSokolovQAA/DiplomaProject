...
public class NameFieldTests extends SetUpClass {
    ...
    @Test
    public void VerifyThatNewHotelCanNotBeSavedWithBlankNameField() throws InterruptedException {
        MainPage mainPage = new MainPage(driver);
        mainPage.openNewHotelPage();
        mainPage.fillInDate();
    ...
    @Test
    public void VerifyThatNewHotelCanBeSaved() throws InterruptedException {
        MainPage mainPage = new MainPage(driver);
        mainPage.openNewHotelPage();
